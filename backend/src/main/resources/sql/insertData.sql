...
VALUES (1, 1,   'Fuersthorse',  'hello, issa me', 5, '2011-01-25T21:34:55', 'paint',   'auhwudhwu288282', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (2, 1,   'Sicundhorse',  'NULL oder so',   4, '2012-01-25T21:34:55', 'ARABIAN', NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (3, null,'Thor.D.horse', 'desc issa me',   3, '2013-01-25T21:34:55', NULL,      'testjeifz783h3jf93j0ur20jf9u', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (4, 2,   '4Horse',       NULL,             2, CURRENT_TIMESTAMP(),   NULL,      NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (5, 2,   '5Horse',       NULL,             1, CURRENT_TIMESTAMP(),   'morgan',  NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (6, 3,   '6Horse',       NULL,             2, CURRENT_TIMESTAMP(),   'appaloosa',NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (7, 6,   '7Horse',       NULL,             3, CURRENT_TIMESTAMP(),   NULL,      NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (8, 9,   '8Horse',       NULL,             4, CURRENT_TIMESTAMP(),   NULL,      NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (9, null,'9Horse',       NULL,             5, CURRENT_TIMESTAMP(),   NULL,      NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
       (10,null,'10Horse',      NULL,             1, CURRENT_TIMESTAMP(),   NULL,      NULL, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
