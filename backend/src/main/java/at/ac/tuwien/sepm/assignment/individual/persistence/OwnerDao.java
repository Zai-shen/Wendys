...
public interface OwnerDao {
     ...
     * @throws PersistenceException will be thrown if something goes wrong during the database access.
     * @throws NotFoundException   will be thrown if the owner to return could not be found in the database.
     */
     ...
     * @throws PersistenceException will be thrown if something goes wrong during the database access.
     * @throws NotFoundException    will be thrown if the owners could not be found in the database.
     * @throws OwnershipException   will be thrown if the owner owns existing horses.
     */
